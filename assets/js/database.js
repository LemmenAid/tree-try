const database = [{
    //QUIZ 1
    title: "Test Your Native Irish Tree Knowledge..",
    questions: [{
...
{
    //QUIZ 2
    title: "Can you identify these trees from the pictures?",
    questions: [{
...
{
    //QUIZ 3
    title: "The pictures won't help with finding the answer, they are just there to jazz thing up!",
    questions: [{
